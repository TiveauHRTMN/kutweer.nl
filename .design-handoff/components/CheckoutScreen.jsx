// Checkout screen — uses Weerzone Piet/Reed/Steve plans
      ...
      <div style={{display:'flex', alignItems:'center', justifyContent:'center', padding: 40, minHeight: 500}}>
        <div className="card" style={{padding: 40, maxWidth: 480, textAlign:'center'}}>
          ...
          <p className="t-small" style={{marginBottom: 24}}>
            Je introductieprijs <strong>{plan.introPrice}</strong> is vastgezet — ook als we live gaan.
          </p>
        ...
        <div style={{display:'grid', gridTemplateColumns:'minmax(0, 1.3fr) minmax(0, 1fr)', gap: 'clamp(20px, 3vw, 32px)'}} className="checkout-grid">
          <div>
            ...
            <p className="t-body" style={{marginBottom: 28}}>
              Nu nog gratis, geen creditcard nodig. Je introductieprijs wordt vastgezet.
            </p>
            ...
            <div className="card card-pad" style={{marginBottom: 20}}>
              ...
              <TextField label="Postcode" value={postcode} onChange={setPostcode} placeholder="1234 AB" hint="We gebruiken dit voor de weermail op jouw adres (KNMI HARMONIE, 2,5 km)."/>
            </div>
          ...
          <div>
            <div className="card card-pad" style={{position:'sticky', top: 88}}>
              ...
              <div style={{display:'flex', justifyContent:'space-between', padding:'12px 0', borderTop:'1px solid var(--border)'}}>
                <span className="t-small">Introductieprijs</span>
                <span style={{fontSize:14, fontWeight:700}}>{plan.introPrice}</span>
              </div>
              <div style={{display:'flex', justifyContent:'space-between', padding:'12px 0', borderTop:'1px solid var(--border)'}}>
                <span className="t-small">Normale prijs later</span>
                <span style={{fontSize:14, fontWeight:700, color:'var(--text-mute)', textDecoration:'line-through'}}>{plan.priceLater}</span>
              </div>
              ...
              <div className="t-small" style={{textAlign:'right', marginTop: 4}}>
                Straks: {plan.introPrice} · opzeggen kan maandelijks
              </div>
