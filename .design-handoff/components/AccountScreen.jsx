          ...
          {tab === 'profile' && (
            <>
              ...
              <div className="card card-pad" style={{marginBottom: 20}}>
                ...
                <TextField label="Thuislocatie" value={loc} onChange={setLoc} hint="Wordt gebruikt voor je dagelijks weerbericht." />
              ...
              <div className="card card-pad">
                ...
                <div style={{display:'grid', gap: 12}}>
                  {[
                    ['daily', 'Dagelijks weerbericht', 'Elke ochtend om 07:00 in je inbox'],
                    ['rain',  'Regen & buien',        'Melding bij regenkans boven 70%'],
                    ['storm', 'Storm & waarschuwingen','KNMI code geel, oranje of rood'],
                    ['uv',    'UV & pollen',          'Als waarden boven de grenswaarde komen'],
                  ].map(([k, l, d]) => (
                    <label key={k} style={{display:'flex', alignItems:'center', gap: 14, padding: '12px 0', borderTop: '1px solid var(--border)'}}>
                      <div style={{flex:1}}>
              ...
              <div className="card" style={{padding: 24, marginBottom: 20, borderColor:'var(--brand)',
                ...
                <div style={{display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap: 20, flexWrap:'wrap'}}>
                  <div>
                    ...
                    <p className="t-small">Introductieprijs {currentPlan.introPrice} vastgezet · Nu gratis</p>
                  </div>
                ...
                {(window.PLANS || []).map(p => (
                  <div key={p.id} className="card" style={{
                    ...
                    <div style={{textAlign:'right'}}>
                      <div style={{fontSize: 16, fontWeight: 800}}>{p.introPrice}</div>
                      <div style={{fontSize: 11, color:'var(--text-mute)'}}>later {p.priceLater}</div>
                      {p.id === plan
...
const PLANS_RANK = {piet:0, reed:1, steve:2};
