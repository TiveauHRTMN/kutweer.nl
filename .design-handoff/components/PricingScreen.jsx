// Real Weerzone plans — Piet / Reed / Steve
const PLANS = [
  {
    id: 'piet',
    name: 'Piet',
  ...
  },
  {
    ...
    priceNow: 'Gratis',
    priceLater: '€49,99/mnd',
    introPrice: '€29,00/mnd',
    introNote: 'vastgezet',
    blurb: 'Steve leest het weer voor 48 uur vooruit en vertaalt het naar wat het voor je zaak betekent: openen, sluiten, inkopen of annuleren.',
    features: [
      ...
      <div style={{padding:'clamp(40px, 6vw, 80px) clamp(20px, 4vw, 48px) 48px', maxWidth: 1200, margin:'0 auto'}}>
          ...
          {PLANS.map(p => (
            <div key={p.id} className="card"
              ...
              <div style={{padding:'14px 16px', background:'var(--ink-050)', borderRadius: 12, marginBottom: 18}}>
                <div style={{fontSize: 13, color:'var(--text-mute)', marginBottom: 2}}>{p.priceLater}, binnenkort</div>
                <div style={{fontSize: 15, fontWeight: 700}}>Introductieprijs: {p.introPrice} <span style={{color:'var(--text-mute)', fontWeight: 500}}>· {p.introNote}</span></div>
              </div>
        ...
        <div style={{marginTop: 'clamp(48px, 6vw, 80px)'}}>
          ...
          <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(260px, 1fr))', gap: 20}}>
            {[
              ...
              ['2', 'Vul je profiel in', 'Postcode en een paar vragen (hond, fiets, kelder, vestiging). Alleen wat je kwijt wilt.'],
        ...
        <div style={{marginTop: 'clamp(48px, 6vw, 80px)'}}>
          ...
          <div style={{maxWidth: 760, margin:'0 auto'}}>
            <FAQ items={[
              ['Waarom is het nu gratis?', 'We zijn nog in opbouw. Je kunt je nu aanmelden zonder te betalen en zonder creditcard. Vroege aanmelders houden hun introductieprijs, ook als we binnenkort live gaan.'],
              ['Wat is het verschil tussen Piet, Reed en Steve?', 'Piet schrijft een dagelijkse weermail voor thuis. Reed stuurt daarnaast alleen bericht als het weer over jouw drempel gaat. Steve doet hetzelfde voor bedrijven, inclusief advies per vestiging over openen, sluiten, inkopen of annuleren.'],
