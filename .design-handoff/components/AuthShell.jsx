    ...
    <div className="auth-shell">
      <aside className="auth-side">
        ...
        <div className="side-hero">
          <h2>{title || "Het weer, zoals jij het wil."}</h2>
          <p>{subtitle || "Iedere ochtend een persoonlijk weerbericht in je inbox. Helder, betrouwbaar, zonder ruis."}</p>
          {quote && (
            <div style={{
              ...
              <p style={{fontSize: 15, lineHeight: 1.55, margin: 0, color: 'rgba(255,255,255,.92)'}}>
                "{quote.text}"
              </p>
              <div style={{marginTop: 12, fontSize: 13, color: 'rgba(255,255,255,.7)'}}>
                — {quote.author}
              </div>
            </div>
          )}
        ...
        <div style={{fontSize: 12, color: 'rgba(255,255,255,.55)'}}>
          © 2026 Weerzone · Dagelijks weer voor Nederland
        </div>
      </aside>
