...
export const metadata: Metadata = {
  ...
  description:
    "WEERZONE vs Buienradar vergeleken: nauwkeurigheid, hyperlokale data, prijzen, radar, waarschuwingen en gebruiksgemak. Ontdek welke weerapp het beste bij jou past.",
  keywords: [
    "weerzone vs buienradar",
    "buienradar alternatief",
    "weerzone buienradar vergelijking",
    "beste weerapp nederland",
    "buienradar vs weerzone",
    "weerzone review",
  ],
  ...
  openGraph: {
    title: "WEERZONE vs Buienradar: Wat is het beste? (2026)",
    description:
      "WEERZONE vs Buienradar: nauwkeurigheid, hyperlokale data, prijzen, radar en waarschuwingen vergeleken.",
    type: "website",
    locale: "nl_NL",
  ...
  twitter: {
    ...
    description:
      "WEERZONE vs Buienradar — nauwkeurigheid, hyperlokale data, prijzen en waarschuwingen vergeleken.",
  },
};

const FEATURE_MATRIX = [
  ["Hyperlokale data (1x1 km)", "✅", "⚠️ Buienradar gebruikt 2,5 km grid"],
  ["48-uurs verwachting per uur", "✅", "❌ Alleen neerslag per 5 min"],
  ["Drie weerkaarten tegelijk", "✅", "❌"],
  ["Meerdere weermodellen", "✅ (HARMONIE, ICON-D2, Arome)", "⚠️ Enkel HARMONIE"],
  ["Neerslagradar live", "✅", "✅"],
  ...
  ["API voor zakelijk gebruik", "✅ (Steve)", "❌"],
  ["Gratis versie", "✅", "✅"],
  ["Premium abonnement", "vanaf €3,99/maand", "€3,99/maand (advertentievrij)"],
  ["Persoonlijke drempelwaarden", "✅ (Reed)", "❌"],
  ["Meerdere locaties", "✅ (Steve)", "❌"],
];
...
export default async function VsBuienradarPage() {
  ...
  const jsonLd = {
    ...
    name: "WEERZONE",
    description:
      "Hyperlokale 48-uurs weersverwachting voor Nederland — reclamevrij, persoonlijk en vertaald naar praktische keuzes.",
          ...
          <div className="space-y-6">
            <div className="card p-6 sm:p-8">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                ...
                neerslag. In deze vergelijking lees je hoe WEERZONE — hyperlokaal, 48 uur vooruit
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="card p-6">
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  <li className="flex gap-2"><span className="text-sky-600 shrink-0">✅</span> Hyperlokale data op 1x1 km grid — nauwkeuriger op jouw adres</li>
                  <li className="flex gap-2"><span className="text-sky-600 shrink-0">✅</span> Drie weermodellen tegelijk (HARMONIE, ICON-D2, Arome)</li>
                  ...
                  <li className="flex gap-2"><span className="text-sky-600 shrink-0">✅</span> API en zakelijke opties (Steve-abonnement)</li>
                </ul>
              ...
              <div className="card p-6">
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  ...
                  <li className="flex gap-2"><span className="text-red-500 shrink-0">❌</span> Geen meerdere weermodellen ter vergelijking</li>
                </ul>
              </div>
            </div>
            ...
            <div className="card p-6">
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {[
                      ...
                      ["Reclamevrij", "✅ (standaard, ook gratis)", "€3,99/maand"],
                      ["Premium persoonlijk", "€3,99/maand (Piet)", "Niet beschikbaar"],
                      ["Waarschuwingen", "€6,99/maand (Reed)", "Niet beschikbaar"],
                      ["Zakelijk", "€499/maand (Steve)", "Niet beschikbaar"],
                    ].map(([row, wz, br], i) => (
                      <tr key={i} className="border-b border-slate-100">
              ...
              <p className="text-[10px] text-slate-400 mt-3">
                Prijzen gecontroleerd op {new Date().toLocaleDateString("nl-NL", { year: "numeric", month: "long", day: "numeric" })}.
            ...
            <div className="card p-6 bg-gradient-to-br from-sky-50 to-white">
              ...
              <p className="text-sm text-slate-600 leading-relaxed mb-4">
                <strong>Kies WEERZONE</strong> als je een hyperlokaal, reclamevrij weerbericht wilt
                dat vertaald is naar concrete keuzes voor jouw dag. Vooral als je persoonlijke
                waarschuwingen op maat belangrijk vindt of als bedrijf weerdata wilt gebruiken.
              </p>
              <p className="text-sm text-slate-600 leading-relaxed mb-4">
