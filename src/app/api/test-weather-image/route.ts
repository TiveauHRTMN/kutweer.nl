...
function buildAffiliateBlock(tag: ConditionTag, temp: number, totalPrecip: number, wind: number, maxTemp: number, minTemp: number): string {
  let productImage = "", productTitle = "", productPrice = "", productOldPrice = "", productUrl = "", reason = "", urgency = "", tagLabel = "";

  switch (tag) {
    case "RAIN":
      productImage = "https://m.media-amazon.com/images/I/71W-kisuJRL._AC_UL320_.jpg";
      productTitle = "Waterdichte regenjas — ademend";
      productPrice = "€49,99"; productOldPrice = "€69,99";
      productUrl = "https://www.amazon.nl/dp/B0DLH9WJSG?tag=tiveaubusines-21";
      reason = `${totalPrecip.toFixed(0)}mm regen verwacht. Een paraplu vergeet je, een jas niet.`;
      urgency = "🔴 Vandaag nog nodig"; tagLabel = "Bestseller";
      break;
    case "HEAT":
    ...
    case "COLD":
      ...
      urgency = "🧊 Kou op komst"; tagLabel = "Deal";
      break;
    case "WIND":
      ...
      urgency = "💨 Windkracht neemt toe"; tagLabel = "Anti-storm";
      break;
    case "PERFECT":
      ...
      urgency = "🌿 Ga naar buiten — nu"; tagLabel = "Prachtweer";
      break;
    default:
      productImage = "https://m.media-amazon.com/images/I/71W-kisuJRL._AC_UL320_.jpg";
      productTitle = "3-in-1 jas — regen, wind én kou";
      productPrice = "€59,99"; productOldPrice = "€79,99";
      productUrl = "https://www.amazon.nl/dp/B0DLH9WJSG?tag=tiveaubusines-21";
      reason = `${minTemp}° tot ${maxTemp}°, wisselvallig. Eén jas voor alles.`;
      urgency = "📦 Morgen in huis"; tagLabel = "Alleskunner";
      break;
  }
...
export async function GET(req: Request) {
  ...
  const affiliateBlock = buildAffiliateBlock(conditionTag, temp, totalPrecip, wind, todayMax, todayMin);
