    ...
    <div className="min-h-screen relative overflow-x-hidden bg-slate-950">
      ...
      <div className="relative z-10 max-w-2xl mx-auto p-4 pb-20 sm:p-6 flex flex-col items-center">
        <div className="text-center mt-12 mb-10">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-white tracking-tight mb-4 drop-shadow-2xl">
