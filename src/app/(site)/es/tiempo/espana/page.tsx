...
export const metadata: Metadata = {
  title: "Tiempo en Espana | Prevision local 48 horas | WEERZONE",
    ...
    <main className="min-h-screen bg-[#f7f4ee] text-slate-950">
      <section className="border-b border-slate-950/10 bg-[#fffaf0]">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          ...
          <Link href="/weer/spanje" className="text-xs font-bold uppercase tracking-[0.16em] text-slate-500 hover:text-slate-950">
            Version NL
          </Link>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-5 py-12">
        ...
        <p className="mt-5 max-w-3xl text-base font-medium leading-7 text-slate-700">
          Consulta el tiempo por ciudad, pueblo, costa o isla. Mariana compara los modelos y Juan traduce la prevision a decisiones practicas para las proximas 48 horas.
        </p>
      </section>
