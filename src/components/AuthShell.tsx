...
export default function AuthShell({ title, subtitle, children, footer, quote }: AuthShellProps) {
  return (
    <div className="auth-shell">
      <aside className="auth-side">
        ...
        <div className="side-hero">
          ...
          <h2 className="whitespace-pre-line">{title || "48 uur vooruit.\nDe rest is ruis."}</h2>
      ...
      <main className="auth-panel">
        <div className="auth-inner">
          {children}
          {footer && <div className="mt-5 text-center text-sm text-text-soft">{footer}</div>}
        </div>
      </main>
    </div>
  );
