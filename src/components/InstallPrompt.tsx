      ...
      <div className="bg-white/95 backdrop-blur-lg rounded-2xl border-2 border-accent-orange p-4 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-bold text-gray-900">
            {isDE ? "WEERZONE installieren?" : "WEERZONE installeren?"}
          </p>
          <p className="text-xs text-gray-500 mt-0.5">
            {isDE ? "Direkt auf deinem Homescreen. Kein App-Store nötig." : "Direct weer op je homescreen. Geen app store nodig."}
          </p>
        </div>
        <button
