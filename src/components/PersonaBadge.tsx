...
export default function PersonaBadge({ tier, size = "md" }: Props) {
  ...
  return (
    <span
      className={`absolute top-1/2 right-0 translate-x-1/2 -translate-y-1/2 ${padding} ${textSize} font-black uppercase tracking-wider text-white rounded-full shadow-lg whitespace-nowrap pointer-events-none select-none z-10 border-2 border-white/90`}
