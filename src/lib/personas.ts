...
export const PERSONAS: Record<PersonaTier, PersonaConfig> = {
  piet: {
    ...
    description:
      "Piet stuurt je elke ochtend voor 7:00 een korte mail: wat het weer vandaag en morgen doet op jouw adres. Bij aanmelden geef je door wat je belangrijk vindt — fietsen, tuin, kinderen — en daar houdt Piet rekening mee.",
    priceCents: 499,
    founderPriceCents: 299,
    features: [
      "Elke ochtend vóór 7:00 in je mail",
      "Op jouw postcode (KNMI HARMONIE, 2,5 km nauwkeurig)",
  ...
  reed: {
    ...
    description:
      "Reed stuurt alleen een bericht als het weer door jouw drempel heen gaat. Jij geeft bij aanmelden aan wanneer je het wil weten — bijvoorbeeld boven windkracht 6 of meer dan 20 mm regen. Bij al het andere laat hij je met rust.",
    priceCents: 799,
    founderPriceCents: 499,
    features: [
      "Alles wat Piet ook stuurt",
      "Waarschuwing op jouw eigen drempel (wind, regen, vorst, onweer)",
  ...
  steve: {
    ...
    description:
      "Steve leest het weer voor de komende 48 uur en vertaalt het naar wat het voor je zaak betekent. Jij stelt per vestiging je drempels in — wind, regen, temperatuur, onweer. Steve geeft vervolgens aan of je moet openen, sluiten, inkopen of annuleren.",
    priceCents: 4999,
